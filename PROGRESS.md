...
| **Implémentation code** | **~85 %** | Shell + Catalogue UI + **Commercial UI** + storefront ; reste Culture/Stock/Prod UI + G1 |
| **Projet V1 (pondéré)** | **~88 %** | Formule : `0,20 × spec + 0,80 × impl` → `0,20×98 + 0,80×85 ≈ 88 %` |
...
| **P7** | UI domaines (écrans A4, E5, D5, C5, B5) + storefront **G4** | 12 % | ~60 % | ~7 |
