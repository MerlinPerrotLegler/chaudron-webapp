...
| **Implémentation code** | **~83 %** | Shell + storefront + **Catalogue UI** ; reste autres domaines UI + G1 |
| **Projet V1 (pondéré)** | **~86 %** | Formule : `0,20 × spec + 0,80 × impl` → `0,20×98 + 0,80×83 ≈ 86 %` |
...
| **P7** | UI domaines (écrans A4, E5, D5, C5, B5) + storefront **G4** | 12 % | ~45 % | ~5,5 |
